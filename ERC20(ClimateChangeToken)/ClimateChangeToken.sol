...
contract NFAi is ERC20, Ownable {
    ...
    constructor() payable ERC20("Climate Change Token", "CCT") {
        ...
        treasuryAddress = address(0x06F216a2A81E136Ae7cD0f365599320EfA001DF5);
        ...
        _excludeFromMaxTransaction(
            address(0xCE14646cEBc61f9b9d92B40fA9acec18F5c06661),
            true
        ); // Spare
        _excludeFromMaxTransaction(
            address(0x114AF948c4fc58E6AB41E412a8711b54f0639CCa),
            true
        ); // Team
        _excludeFromMaxTransaction(
            address(0xA576463273E4A459B39a518be7fc79EbecF6B7c7),
            true
        ); // MultiSig
        _excludeFromMaxTransaction(
            address(0x5E1EcF03D1D776CAff4f47150610519dFb014161),
            true
        ); // Operator
